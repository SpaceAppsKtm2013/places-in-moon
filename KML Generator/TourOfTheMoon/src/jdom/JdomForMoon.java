...
//            Moon moonInfo=moonList.get(i);
         {
            ...
            placeMark="<name> "+moonInfo.getImageId()+" </name>";
            writeStringToFile(placeMark);
            placeMark="<description><h1>Image Id"+moonInfo.getImageId()+"</h1>";
            writeStringToFile(placeMark);
            String imageLink=moonInfo.getImageLink();
            String[] imageL=imageLink.split("&");
            imageL[0]+="&amp;";
            imageLink=imageL[0]+imageL[1];
            placeMark="<img src=\""+imageLink+"\" height=\"100\" width=\"100\"/>";
            writeStringToFile(placeMark);
...
//              Moon moonInfo=moonList.get(i);
        ...
        imageL[0]+="&amp;";
        imageLink=imageL[0]+imageL[1];
        groundOverLay="<href>"+imageLink+"</href>";
        writeStringToFile(groundOverLay);
    ...
    private void writeStringToFile(String contentToBeWritten)
    {
          try {
             ...
             bout = new BufferedWriter(new FileWriter("MoonData1000.kml",true));
